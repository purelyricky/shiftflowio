      ...
      <div className="container">
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            ...
            Streamline Shift Management and Payroll with Ease
            </h1>
            <p className="text-xl text-[#010D3E] tracking-tight mt-6">
            Empower your agency/workforce to effortlessly assign shifts, track attendance, and calculate payments—all in one intuitive platform.
            </p>
